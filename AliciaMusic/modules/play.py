...
from AliciaMusic.helpers.channelmusic import get_chat_id
from AliciaMusic.helpers.errors import DurationLimitError
from AliciaMusic.helpers.decorators import errors
from AliciaMusic.helpers.decorators import authorized_users_only
from AliciaMusic.helpers.filters import command, other_filters
from AliciaMusic.helpers.gets import get_file_name
from AliciaMusic.services.callsmusic import callsmusic, queues
from AliciaMusic.services.callsmusic.callsmusic import client as USER
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your group due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @AliciaGroup_bot and @AliciaBotAssistant to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
